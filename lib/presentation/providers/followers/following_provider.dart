...
final followingProvider = StateNotifierProvider<FollowingNotifier, List<User>>((ref) {
   return FollowingNotifier(authUseCase, userUseCase);
});

class FollowingNotifier extends StateNotifier<List<User>> {
  final AuthUseCase _authUseCase;
  final UserUseCase _userUseCase;
  FollowingNotifier(this._authUseCase, this._userUseCase) : super([]);
